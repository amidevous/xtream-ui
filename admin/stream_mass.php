...
if (isset($_POST["submit_stream"])) {
    ...
    if (count($rStreamIDs) > 0) {
        ...
        if (isset($_POST["restart_on_edit"])) {
            ...
            $rNull = file_get_contents($rAPI."?action=stream&sub=stop&stream_ids[]=".join(",", $rStreamIDs));
            $rNull = file_get_contents($rAPI."?action=stream&sub=start&stream_ids[]=".join(",", $rStreamIDs));
        }
    }
    $_STATUS = 0;
}
    ...
    include "header.php";
                                            ...
                                            <div class="tab-pane" id="stream-selection">
                                                <div class="row">
                                                    <table id="datatable" class="table table-borderless mb-0">
                                                        ...
                                                        <tbody>
                                                            <?php foreach (getStreamList() as $rStream) { ?>
                                                            <tr data-id="<?=$rStream["id"]?>">
                                                                <td class="text-center"><?=$rStream["id"]?></td>
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <label class="col-md-3 col-form-label" for="gen_timestamps">Generate PTS <i data-toggle="tooltip" data-placement="top" title="" data-original-title="Allow FFmpeg to generate presentation timestamps for you to achieve better synchronization with the stream codecs. In some streams this can cause de-sync." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-2">
                                                                <input name="gen_timestamps" id="gen_timestamps" type="checkbox" data-plugin="switchery" class="js-switch" data-color="#039cfd"/>
                                                            </div>
                                                            <label class="col-md-3 col-form-label" for="read_native">Native Frames <i data-toggle="tooltip" data-placement="top" title="" data-original-title="You should always read live streams as non-native frames. However if you are streaming static video files, set this to true otherwise the encoding process will fail." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <label class="col-md-3 col-form-label" for="stream_all">Stream All Codecs <i data-toggle="tooltip" data-placement="top" title="" data-original-title="This option will stream all codecs from your stream. Some streams have more than one audio/video/subtitles channels." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <label class="col-md-3 col-form-label" for="rtmp_output">Allow RTMP Output <i data-toggle="tooltip" data-placement="top" title="" data-original-title="Enable RTMP output for this channel." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-2">
                                                                <input name="rtmp_output" id="rtmp_output" type="checkbox" data-plugin="switchery" class="js-switch" data-color="#039cfd"/>
                                                            </div>
                                                            <label class="col-md-3 col-form-label" for="direct_source">Direct Source <i data-toggle="tooltip" data-placement="top" title="" data-original-title="Don't run source through Xtream Codes, just redirect instead." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <label class="col-md-3 col-form-label" for="delay_minutes">Minute Delay <i data-toggle="tooltip" data-placement="top" title="" data-original-title="Delay stream by X minutes. Will not work with on demand streams." class="mdi mdi-information"></i></label>
                                                            <div class="col-md-2">
                                                        ...
                                                        <div class="form-group row mb-4">
                                                            ...
                                                            <label class="col-md-3 col-form-label" for="http_proxy">HTTP Proxy <i data-toggle="tooltip" data-placement="top" title="" data-original-title="Format: ip:port" class="mdi mdi-information"></i></label>
                                                            <div class="col-md-8">
        ...
        $(document).ready(function() {
            ...
            $("#stream_form").submit(function(e){
                ...
                var rStreams = [];
                $($("#datatable").DataTable().rows('.selected').data()).each(function(rID, rStream) {
                    rStreams.push(rStream[0]);
                });
                $("#streams").val(JSON.stringify(rStreams));
