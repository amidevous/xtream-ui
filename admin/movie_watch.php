                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Movies - Folder Watch</h4>
                        </div>
                    </div>
                </div>     
                <!-- end page title --> 
                        ...
                        <div class="card">
                            <div class="card-body" style="overflow-x:auto;">
                                <table id="datatable" class="table dt-responsive nowrap">
                                    ...
                                    <tbody>
                                        <?php foreach (getWatchFolders("movie") as $rFolder) {
                                        ...
                                        <tr id="folder-<?=$rFolder["id"]?>">
                                            ...
                                            <td class="text-center">
                                                <a href="./movie_watch_folder.php?id=<?=$rFolder["id"]?>"><button type="button" class="btn btn-outline-info waves-effect waves-light btn-xs"><i class="mdi mdi-pencil-outline"></i></button></a>
